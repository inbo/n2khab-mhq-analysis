...
map_beheer <- st_read(file.path(path_beheer, "passend_beheer.gpkg"), quiet = TRUE) %>%
...
sample_cycle2 <- st_read(file.path(path_design_ws,
                           "mhq_standingwater_cycle2_2024-04-17.gpkg"), quiet = TRUE) %>%
  st_drop_geometry()
...
```{r}
sampleframe_3260_orig <- st_read("../../data/raphab25/n2khab-mhq-data/processed/3260_steekproefkader/steekproefkader_3260_v1_7_strata.shp", quiet = TRUE)
...
+ We maken een schatting vanaf `r nmin_trend` herhaalde waarnemingen
