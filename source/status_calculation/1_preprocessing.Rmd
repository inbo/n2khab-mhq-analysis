...
+ de tabel 'mapping_table_inbocode' met een vertaling van de oude watervlakkencodes naar de nieuwe watervlakkencodes (die gebruikt worden ind e watervlakkenlaag)
...
Vervolgens bepalen we de totale oppervlakte van elk stratum op basis van 'watersurfaces_hab_v6' en 'mhq_watersurfaces_assessments'.
...
ws_hab_type <- watersurfaces_hab_table %>%
  ...
  left_join(select(mhq_ws_assessments, code_watersurfaces = polygon_id, type, is_present, assessment_date), by = c("code_watersurfaces", "type" )) %>%
...
We berkenen de totale lengte in elk stratum.
