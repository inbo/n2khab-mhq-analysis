# MHQ Heath and inland dunes

```{r}
lsvi_detail <- read_vc(root = file.path(path_lsvi, "lsvi_mhq/heath_inland_dunes/result"),
                             file = "lsvi_detail_hs_id")

lsvi_globaal  <- read_vc(root = file.path(path_lsvi, "lsvi_mhq/heath_inland_dunes/result"),
                             file = "lsvi_globaal_hs_id")

lsvi_indicator  <- read_vc(root = file.path(path_lsvi, "lsvi_mhq/heath_inland_dunes/result"),
                             file = "lsvi_indicator_hs_id")

data_habitat  <- read_vc(root = file.path(path_lsvi, "lsvi_mhq/heath_inland_dunes/input"),
                             file = "data_habitat_hs_id")
...
check_missing_mhq_admin <- data_habitat_cat %>%
  ...
  left_join(add_point_code, by = "user_reference") # to check
