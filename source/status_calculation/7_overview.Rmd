...
status_habsubt_2190_a <- status_flanders %>%
...
write_csv2(status_flanders, "../output/status_habitatkwaliteit_2025-24-02.csv")
...
trend_flanders %>%
  filter(parameter == "verschil_aandeel_gunstig_abs") %>%
write_csv2("../output/trend_habitatkwaliteit_2025-24-02.csv")
```
