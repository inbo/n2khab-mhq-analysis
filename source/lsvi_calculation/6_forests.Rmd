...
correct_status_globaal <- lsvi_fs$Resultaat_indicator %>%
  ...
  summarise(n_gunstig = sum(Status_indicator),
            ...
            zb_ongunstig = str_c(ifelse(Status_indicator == FALSE & Belang == "zb", Indicator, ""), collapse = "; "),
  ...
  ungroup() %>%
  select(ID, Habitattype, n_zb_ongunstig, zb_ongunstig, aandeel_gunstig, status_habitatvlek, index_mean_ind, index_mean_crit)
