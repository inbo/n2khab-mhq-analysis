...
data_voorwaarden_fs <- get_voorwaarden_fs(data_path = path_mhq_anb,
                                          data_path_extra_var = path_extra_var,
                          record_ids = c(data_habitat_mhq_fs$record_id_square))

data_soorten_kenm_fs <- get_soorten_kenmerken(data_path_inboveg = path_mhq_terr,
...
voorwaarden_module <- overzicht_lsvi %>%
  anti_join(data_voorwaarden_fs, by = "Voorwaarde")
```
...
data_habitat_2330 <- data_habitat_fs %>%
