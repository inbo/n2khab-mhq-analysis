...
Gebruiken we voor de analyse ook de data van de rapportage uit 2019 of is deze data niet vergelijkvaar met de huisige dataset?

De coördinaten van de meetpunten die in 2024 werden opgemeten ontbreken nog.

Voor de rapportage uit 2019 werden structuurvariabelen voor 1330_da bepaald op niveau van schor. Kunnen de structuurvariabelen (of deel ervan) opnieuw bepaald worden?. 
...
Bij 91E0_sf zijn er een aantal meetpunten waar de voorwaarde 'aantal exemplaren dik dood hout per ha' niet werd bepaald.
...
De waarde van MSA ontbreekt voor de plots waar de coördinaten nog ontbrejen (opnames 2024).
...
Volgende soorten worden zowel in de vierkante als de cirkelplot bepaald:

+ Caltha palustris (dotterbloem)
+ Cardamine amara (bitter veldkers)
