...
correct_status_globaal <- lsvi_gr_bm$Resultaat_indicator %>%
...
correct_status_criterium <- lsvi_gr_bm$Resultaat_indicator %>%
  filter(!is.na(Status_indicator)) %>%
...
lsvi_gr_bm$Resultaat_globaal <- lsvi_gr_bm$Resultaat_globaal %>%
  left_join(correct_status_globaal, by = c("ID", "Habitattype")) %>%
  mutate(Status = status_habitatvlek) %>%
  select(-status_habitatvlek)

lsvi_gr_bm$Resultaat_criterium <- lsvi_gr_bm$Resultaat_criterium %>%
