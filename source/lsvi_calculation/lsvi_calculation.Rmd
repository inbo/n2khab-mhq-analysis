...
Voor voorwaarde open plek:
+ Als waarde ontbreekt voor cirkelplot gebruiken we waarde voor bedekking naakte bodem van vierkante plot
+ Als waarde ook ontbreekt in vierkante plot veronderstellen we 0 % bedekking

Voorwaarde aantal struweelsoorten: indien geen enkele bedekking is ingevuld voor een van de struweeltypes:
+ als duindoorn niet aanwezig is veronderstellen we dat er 0 struweelsoorten zijn
+ als duindoorn wel aanwezig is, is het aantal struweelsoorten onbekend (NA)

Voorwaarde spontane verstuiving: indien geen enkele vedekking is ingevuld voor een van de verstuivingsklassen:
